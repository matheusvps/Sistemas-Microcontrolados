...
// Definições de configuração do UART0 para a equipe
#define UART0_BAUD_RATE 115200
#define UART0_PARITY    UART0_PARITY_EVEN
#define UART0_STOPBITS  UART0_STOPBITS_1
...
void uart0_init(void) {
    ...
    uint32_t lcrh = UART_LCRH_WLEN_8 | UART_LCRH_FEN;
    // Paridade
    #if UART0_PARITY == UART0_PARITY_ODD
        lcrh |= UART_LCRH_PEN;
    #elif UART0_PARITY == UART0_PARITY_EVEN
        lcrh |= UART_LCRH_PEN | UART_LCRH_EPS;
    #endif
    // Stop bits
    #if UART0_STOPBITS == UART0_STOPBITS_2
        lcrh |= UART_LCRH_STP2;
    #elif UART0_STOPBITS == UART0_STOPBITS_1
        lcrh |= UART_LCRH_STP
    #endif
    UART0_LCRH_R = lcrh;
