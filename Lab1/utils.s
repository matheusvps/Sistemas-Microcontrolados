...
SYSCLK EQU (FXTAL/(Q+1)/(N+1))*(MINT+MFRAC/1024)/(PSYSDIV+1)
    ...
    LDR R3, =SYSCTL_PLLFREQ0_MFRAC_M           ; R3 = SYSCTL_PLLFREQ0_MFRAC_M (máscara)
...
PLL_Init_step7toofast                          ; 120 MHz < SysClk: "too fast"
    ; A configuração é inválida e o PLL não pode operar mais rápido do que 120MHz.
...
PLL_Init_step7fullspeed                        ; 100 MHz < SysClk <= 120 MHz: "full speed"
    ...
    BLS PLL_Init_step7veryfast                 ; se sim, pula o práximo teste
